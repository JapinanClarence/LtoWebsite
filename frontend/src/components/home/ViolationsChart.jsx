...
export function ViolationsChart() {
  ...
  return (
    <Card className="md:shadow-none">
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          <CardTitle>Violations and Accidents Overview</CardTitle>
          <CardDescription>Showing violation and accident frequency for the last 3 months</CardDescription>
        </div>
        <div className="flex">
